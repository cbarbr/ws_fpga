...
## Clock signal
# set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { ext_clk100 }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]

#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { ext_clk100 }];
...
## USB-UART Interface
set_property -dict {PACKAGE_PIN AK16 IOSTANDARD LVCMOS33} [get_ports uart_rxd_out]
set_property -dict {PACKAGE_PIN AJ16 IOSTANDARD LVCMOS33} [get_ports uart_txd_in]
...
set_property -dict {PACKAGE_PIN AJ18 IOSTANDARD LVCMOS33} [get_ports ext_rstn]
...
set_property PACKAGE_PIN F9 [get_ports ext_clk_p]
set_property IOSTANDARD LVDS [get_ports ext_clk_n]
set_property IOSTANDARD LVDS [get_ports ext_clk_p]
